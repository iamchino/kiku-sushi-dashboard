-- ############################################################################
--  KIKU SUSHI — Arreglo puntual: envio_config / envio_zonas
--
--  Pegalo en Supabase → SQL Editor y dale Run. Va todo en una transacción:
--  si algo falla, no se aplica nada.
--
--  Después volvé a correr SQL_EDITOR_VERIFICACION.sql: el chequeo 2 tiene que
--  pasar a ✅.
-- ############################################################################
