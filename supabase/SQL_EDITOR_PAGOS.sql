-- ############################################################################
--  KIKU SUSHI — Pagos centralizados en Caja
--
--  Pegalo entero en Supabase → SQL Editor y dale Run, una sola vez.
--  Idempotente: re-correrlo no rompe nada.
--
--  Después mergeá/deployá el front (branch feat/pagos-centralizados).
--  Orden recomendado: primero este SQL, después el deploy.
-- ############################################################################
