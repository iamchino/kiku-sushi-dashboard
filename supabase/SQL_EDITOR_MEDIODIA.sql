-- ════════════════════════════════════════════════════════════════════════════
-- KIKU MEDIODÍA COMPLETO — pegar todo junto en el SQL Editor
-- Habilita: franjas de mediodía mar–vie, turnos 11:00–15:00, y los menús
-- gestionables desde Configuración → Reservas.
-- ════════════════════════════════════════════════════════════════════════════

-- 1. Franjas: mediodía martes a viernes (noche queda como está)
update public.reservas_dias set mediodia = (dow in (2,3,4,5));

-- 2. Turnos de mediodía (última entrada 15:00)
update public.reservas_config
   set mediodia_slots = array['11:00','11:30','12:00','12:30','13:00','13:30','14:00','14:30','15:00'],
       updated_at = now()
 where id = 1;

-- 3. Menús de mediodía (columna nueva + seed)
-- ============================================================================
...
-- Verificación
select dow, mediodia, noche from public.reservas_dias order by dow;
