-- ============================================================
-- 04 · ORDEN de toda la Carta Salon (135 items, 0..134) por nombre.
-- Flujo: Especial > Combinados > Entradas > Principales de sushi >
-- Principales cocina > Postres > Bebidas/Cervezas/Vinos.
-- Entradas: ...Tempura > Causas > Carpaccios > CEVICHES > Tiraditos...
-- Correr DESPUES de 02. Solo cambia 'orden'.
-- ============================================================
begin;
