...
values
  ...
  ('carta', 'Rollos de Sushi', NULL, '8 Tamago roll', 'Queso, palmitos y salmón. Envuelto en lámina de tamago. Coronado en salsa maracuyá. Top de hilos de boniato frito.', 16000, NULL, true, 34, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/8-tamago-roll.jpg'),
  ('carta', 'Rollos de Sushi', NULL, '8 Tamago palta roll', 'Queso, palmito y palta. Envuelto en lámina de tamago. Salsa maracuyá, coronado de hilos de boniato frito.', 16000, NULL, true, 35, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/8-tamago-palta-roll.jpg'),
  ('carta', 'Rollos de Sushi', NULL, '8 Tamago ebi furai roll', 'Queso cítrico y ebi furai. Envuelto en lámina de tamago. Coronado en salsa maracuyá. Top de hilos de boniato frito.', 16500, NULL, true, 36, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/8-tamago-ebi-furai-roll.jpg'),
  ('carta', 'Rollos de Sushi', NULL, '9 Huanca Roll', 'Langostinos furai y palta. Semicubierto de salmón. Coronado en salsa huancaína y polvo de aceituna.', 16000, NULL, true, 37, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/9-huanca-roll.jpg'),
  ...
  ('carta', 'Saltados', 'Platos de cocina', 'Saltado de Lomo', 'Cebolla, zanahoria y morrones. Acompañado de arroz gohan y furikake. Salsa de soja y aceite de sésamo.', 19000, NULL, true, 45, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/saltado-de-lomo.jpg'),
  ('carta', 'Saltados', 'Platos de cocina', 'Saltado de Pollo', 'Cebolla, zanahoria y morrones. Acompañado de arroz gohan y furikake. Miel, mostaza y aceite de sésamo.', 19000, NULL, true, 46, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/saltado-de-pollo.jpg'),
  ('carta', 'Saltados', 'Platos de cocina', 'Saltado Veggie', 'Cebolla, zanahoria y morrones. Acompañado de arroz gohan y furikake.', 16000, NULL, true, 47, 'https://sepyieuxsmxhzobtmzxb.supabase.co/storage/v1/object/public/menu-images/carta/saltado-veggie.jpg'),
