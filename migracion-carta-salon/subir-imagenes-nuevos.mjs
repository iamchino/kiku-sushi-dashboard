/**
 * Descarga las imágenes de la CARTA SALÓN · 40 ITEMS NUEVOS (Cloudinary del sitio viejo)
...
const productos = JSON.parse(readFileSync(join(__dirname, 'nuevos-items.json'), 'utf8'))
