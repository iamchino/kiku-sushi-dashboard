/**
 * Descarga las imágenes de la carta delivery (Cloudinary del sitio viejo)
 * y las sube al bucket "menu-images/delivery/<slug>.jpg" de tu Supabase.
 *
 * Las rutas coinciden exactamente con las imagen_url del archivo
 * carta-delivery.sql, así que el SQL y las imágenes quedan sincronizados.
 *
 * Uso:
